...
def show():
    ...
    if section == "Introduction":
        ...
        st.markdown("""
                    ...
                    Recently, the music world was abuzz with the release of a new single from Drake featuring The Weekend, marked by the catchy lyrics and beats that fans have come to expect.
                    ...
                    This revelation didn't just stir up the music industry; it sparked a profound fascination within me. Thus began this passion project.</div>""", unsafe_allow_html=True)
        st.write("")
