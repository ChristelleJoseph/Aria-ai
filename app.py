...
def show():
    ...
    if st.button('Generate Music'):
        ...
        st.title("EDM-ify")
        st.write("""
                Please note: The audio quality and overall harmony may vary based on the accompanying instruments chosen.
                This can be attributed to the soundfont (.s2f) utilized, which, despite being the best option I could find, may not always produce the desired sound.
                 """)
        st.audio(edm_track)
        ...
        st.write("""
                 The concept here is to use the MIDI file generated by the RNN model as a starting point.
                 You can import this file into a digital audio workstation like GarageBand and turn it into something that sounds really cool!
                 Example: 
                 """)
